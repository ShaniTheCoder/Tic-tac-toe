...
var url = "https://opentdb.com/api.php?amount=9&category=9&difficulty=easy&type=multiple";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("HTTP error! error code : ".concat(response.status));
                    }
                ...
                case 3:
                    error_1 = _a.sent();
                    console.log("Error fetching the trivia question", error_1);
                    throw error_1;
...
fetchTrivia().then(function (data) {
    console.log(data);
